...
int aeif_cond_alpha::Calibrate(float time_min, float /*time_resolution*/)
{
...
template <>
int aeif_cond_alpha::UpdateNR<0>(int it, float t1)
{
  return 0;
}

int aeif_cond_alpha::Update(int it, float t1) {
