...
int main(int argc, char *argv[])
{
  ...
  ngpu.SetNeuronParam("E_rev", neur_group2, E_rev, 3);
  ngpu.SetNeuronParam("taus_decay", neur_group2, taus_decay, 3);
  ngpu.SetNeuronParam("taus_rise", neur_group2, taus_rise, 3);
  ngpu.SetNeuronParam("E_rev", neur_group3, E_rev, 3);
  ngpu.SetNeuronParam("taus_decay", neur_group3, taus_decay, 3);
  ngpu.SetNeuronParam("taus_rise", neur_group3, taus_rise, 3);
