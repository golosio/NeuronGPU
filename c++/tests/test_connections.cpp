...
int main(int argc, char *argv[])
{
  ...
  ngpu.SetNeuronParam(neur_group2, "taus_decay", taus_decay, 3);
  ngpu.SetNeuronParam(neur_group2, "taus_rise", taus_rise, 3);
  ngpu.SetNeuronParam(neur_group3, "E_rev", E_rev, 3);
  ngpu.SetNeuronParam(neur_group3, "taus_decay", taus_decay, 3);
  ngpu.SetNeuronParam(neur_group3, "taus_rise", taus_rise, 3);
