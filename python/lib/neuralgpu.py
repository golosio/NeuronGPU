...
def SetNeuronPtArrayParam(nodes, param_name, params_list):
...
def SetNeuronPtArrayVar(nodes, var_name, vars_list):
...
def GetNeuronParam(i_node, n_nodes, param_name):
...
def GetNeuronVar(i_node, n_nodes, var_name):
